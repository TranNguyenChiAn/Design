...
$sqlCountRecord = "SELECT COUNT(*) AS count_record FROM customers 
...
<section class="main_content">
    ...
    <!-- LIST -->
    <p class="table_title"> MANAGE CUSTOMER </p>
    <table class="table-admin" border="0" cellspacing="0" cellpadding="10" width="100%">
        <tr>
            ...
            <th class="t-heading" width="50px"> Action </th>
        </tr>
        <?php
        ...
        ?>
                <tr class="record">
                    ...
                    <td style="display: flex; justify-content: space-around">
                        <a class="edit"  href="edit.php?id=<?= $customer['id'] ?>">
                            <img width="30px" src="../../image/edit.png">
                        </a><br>
                        <a class="delete"  href="destroy.php?id=<?= $customer['id'] ?>">
