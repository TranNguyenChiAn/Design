...
<section class="main_content">
    ...
    <div>
        <button class="menu_button" id="pending">
            <a class="link_in_button" style="color:#6868de;" href="pending.php">
                Pending
            </a>
        </button>
        <button class="menu_button" id="delivery">
            <a class="link_in_button" style="color:#6868de;" href="delivery.php">
                Delivery
            </a>
        </button>
        <button class="menu_button" id="completed">
            <a class="link_in_button" style="color:#6868de;" href="completed.php">
                Completed
            </a>
        </button>
        <button class="menu_button" id="canceled">
            <a class="link_in_button" style="color:#6868de;" href="canceled.php">
                Canceled
            </a>
        </button>
    </div>
