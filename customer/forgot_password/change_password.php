...
<div class="form_login" >
    ...
    <form align="center" id="form" method="post" action="change_process.php">
        ...
        <img id="showEye2" src="../../image/view.png" onclick="newPasswordShow()">
        <img id="hideEye2" src="../../image/hidden.png" onclick="newPasswordHide()">
        <br>
        <br>
    ...
    <a style="color: white; font-style: italic; font-size:16px " href="../forgot_password/index.php">
        Forgot Password
    </a>
</div>
